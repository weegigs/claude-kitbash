...
Generate the following files using templates from [references/templates.md](references/templates.md):
- `mission.md` — Product mission, problem, users, solution
- `roadmap.md` — MVP features and post-launch phases
